...
Exclude data and model weights; keep plots/CSV if you want to showcase results.
...
# Data & Large files (exclude)
data/

# Model weights & logs (exclude)
outputs/*.pt
outputs/*.log

# Keep compare artifacts (uncomment 
if you want to include)
# !outputs/compare_results.csv
# !outputs/compare_bar_acc.png
# !outputs/compare_bar_loss.png
# !outputs/train_curves_food101.png
```
## Acknowledgments
